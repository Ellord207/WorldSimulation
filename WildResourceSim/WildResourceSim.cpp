...
int main()
{
	...
	std::cout << "Is there wasteland: " << world.IsBiome(1, 1, Nature::Wasteland) << std::endl;	//true
	std::cout << "Is there Desert: " << world.IsBiome(1, 1, Nature::Desert) << std::endl;		//false
	std::cout << "Is there Forest: " << world.IsBiome(4, 4, Forest) << std::endl;		//true
	std::cout << "Is there wasteland: " << world.IsBiome(5, 5, Nature::Wasteland) << std::endl;	//false
